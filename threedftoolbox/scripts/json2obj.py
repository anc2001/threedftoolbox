...
parser.add_argument(
    "--future_path", default="3D-FUTURE-model", help="path to 3D FUTURE"
)
parser.add_argument(
    "--texture_path", default="3D-FRONT-texture", help="path to hard tex"
)
parser.add_argument("--json_path", default="3D-FRONT", help="path to 3D FRONT")

parser.add_argument("--save_path", default="./output", help="path to save result dir")
