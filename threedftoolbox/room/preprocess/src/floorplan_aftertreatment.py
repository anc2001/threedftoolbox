        ...
        while len(pts_list) > 0:
            ...
            first_poly = Polygon(
                [
                    ...
                    (first_rect[2], first_rect[3]),
                    (first_rect[4], first_rect[5]),
                    (first_rect[6], first_rect[7]),
                ]
            )
            ...
            for i, rest_rect in enumerate(pts_list):
                if i > 0:
                    rest_poly = Polygon(
                        [
                            (rest_rect[0], rest_rect[1]),
                            (rest_rect[2], rest_rect[3]),
                            (rest_rect[4], rest_rect[5]),
                            (rest_rect[6], rest_rect[7]),
                        ]
                    )
